...
class Build:
    ...
    def __init__(self, environment):
        ...
        self.man = []
        self.data = []
        self.static_linker = PerMachine(None, None, None)
        self.subprojects = {}
        self.subproject_dir = ''
...
class BuildTarget(Target):
    ...
    def validate_install(self, environment):
        if self.for_machine == MachineChoice.BUILD and self.need_install:
    ...
    def link(self, target):
        for t in listify(target, unholder=True):
            ...
            if isinstance(self, SharedLibrary) and isinstance(t, StaticLibrary) and not t.pic:
                ...
                raise InvalidArguments(msg)
            if self.for_machine != t.for_machine:
...
class CustomTarget(Target):
    ...
    # TODO expose keyword arg to make this configurable
